...
const Footer = () => {
    return (
      <footer className="text-center lg:text-left bg-black text-white">
        <div className="flex justify-center lg:justify-start p-6 py-12 ">
          <Image
        ...
        <div className="flex justify-center items-center lg:justify-center p-6 border-b border-gray-300">
          ...
          <div className="flex justify-center">
            <a href="https://www.facebook.com/ehubgg" className="mr-6 text-white">
            ...
            <a href="https://discord.gg/qChmrsNpuq" className="mr-6 text-white">
            ...
            <a href="https://www.instagram.com/ggehub/" className="mr-6 text-white">
            ...
            <a href="https://www.linkedin.com/company/ehubdotgg/" className="text-white">
        ...
        <div className="flex justify-center items-center lg:justify-center p-6">
          <div className='mr-12 hidden lg:block'>
            <span className='pb-2'>Contact us:</span>
          </div>
  
          <div>
            <Link href="mailto:info@ehub.gg">
              <a className="text-white flex justify-content pb-2 italic">
            ...
            <p className="text-white flex justify-content">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="w-4 mr-4" viewBox="0 0 16 16">
        ...
        <div className="text-center p-6 bg-black">
          ...
          <p className="text-white font-semibold">EHUB ApS</p>
        </div>
      </footer>
