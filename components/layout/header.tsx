        ...
        <div className="hidden lg:block flex items-center justify-between flex-wrap">
          <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
            ...
            <div className="lg:flex-grow ml-12">
              <Link href="/" passHref>
                <a className="inline-block mt-0 text-teal-200 hover:text-white mr-10 font-bold">Home</a>
              </Link>
              <Link href="/about" passHref>
                <a className="inline-block mt-0 text-teal-200 hover:text-white mr-10 font-bold">Ladders</a>
              </Link>
              <Link href="/academy" passHref>
                <a className="inline-block mt-0 text-teal-200 hover:text-white mr-10 font-bold">Cups</a>
              </Link>
              <Link href="/academy" passHref>
                <a className="inline-block mt-0 text-teal-200 hover:text-white font-bold">Profile</a>
              </Link>
            </div>
            <div>
